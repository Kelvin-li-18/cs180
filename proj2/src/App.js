        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              columns: 3,
              images: [
                { title: 'Pomeranian', imageUrl: '/images/pom.jpeg' },
                { title: 'Egg', imageUrl: '/images/egg.jpeg' },
                { title: 'Pom-Egg (Failed)', imageUrl: '/images/hybrid_pomegg.jpg' },
              ],
            },
            {
              type: 'image-grid',
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            { type: 'paragraph', text: 'The Laplacian stack splits an image into different frequency bands. First build a Gaussian stack where each level is derived from convolving the original image with a Gaussian kernel of increasing sigma. By taking the difference between 2 consecutive levels of the Gaussian stack, the Laplacian stack represents the band of frequency lost between the 2 levels of the Gaussian stack. The highest level of the Laplacian stack is set to be equal to the highest level of the Gaussian stack since there are no higher levels of the Gaussian stack left to subtract.' },
            {
              ...
              columns: 1,
              images: [
                { title: 'Laplacian Stack', imageUrl: '/images/laplacianstack.png' },
              ],
            },
            {
            ...
            },
            {
              ...
              columns: 1,
              images: [
                { title: 'Laplacian Stack Fourier Transform', imageUrl: '/images/laplacian_stack_plot.png' },
              ],
            },
        ...
        },
        {
          ...
          content: [
            { type: 'paragraph', text: '2 images can be blended togther by splitting them into their respective Laplacian stacks, blending each level of the Laplacian stacks separetly, and summing together the blended levels to construct the blended image.' },
            ...
            { type: 'paragraph', text: 'For instance, here is an Apple blended with an Orange' },
            {
              ...
              columns: 3,
              images: [
                { title: 'Apple', imageUrl: '/images/apple.jpeg' },
                { title: 'Orange', imageUrl: '/images/orange.jpeg' },
                { title: 'Orapple', imageUrl: '/images/blendedappleorange.jpg' },
              ],
            },
            {
              type: 'image-grid',
              columns: 1,
              images: [
                { title: 'Blending Process', imageUrl: '/images/blending.jpg' },
              ],
            },
          ],
        },
        {
          ...
          content: [
            { type: 'paragraph', text: 'Here are more examples of multi-resolution blending with different image pairs.' },
            {
              ...
              columns: 4,
              images: [
                { title: 'Pomeranian', imageUrl: '/images/bobo.jpg' },
                { title: 'Tiger', imageUrl: '/images/tiger.jpg' },
                { title: 'Mask', imageUrl: '/images/bobo_mask.jpg' },
                { title: 'Pomger', imageUrl: '/images/pomger.jpg' },
              ],
            },
            {
              type: 'image-grid',
              columns: 4,
              images: [
                { title: 'Whale', imageUrl: '/images/whale.jpg' },
                { title: 'Space', imageUrl: '/images/galaxy.jpg' },
                { title: 'Mask', imageUrl: '/images/whale_mask.jpg' },
                { title: 'Space Whale', imageUrl: '/images/whalespace.jpg' },
              ],
            },
          ],
        },
